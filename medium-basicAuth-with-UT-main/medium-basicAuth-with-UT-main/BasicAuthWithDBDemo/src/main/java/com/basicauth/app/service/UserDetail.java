...
public class UserDetail implements UserDetailsService {
	...
	public Long getUserIdByEmail(String email) {
		// Use the repository to fetch the user and return their ID
		return registerNewUserRepository.findByEmail(email)
				.map(UserProfile::getId) // Get the ID from the User entity
